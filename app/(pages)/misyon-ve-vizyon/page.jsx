...
const MisyonPage = () => {
  return (
    <main className=" mt-20  ">
      ...
      <article className=" mt-12 px-20 gap-10">
        <div className="flex flex-col items-center justify-center  my-5">
          <h1 className="text-2xl font-semibold ">Misyonumuz</h1>
          <hr className="w-32 h-[3px] bg-primary"></hr>
        </div>
        <div className="items-center justify-center gap-4  w-full  mt-5 ">
          <p className="flex items-center justify-center mb-4">
            Turhanlar Petrol olarak misyonumuz, müşteri memnuniyetini en üst
            seviyeye çıkarmak, kaliteli yakıt ve ek hizmetler sunarak güvenilir
            ve sürdürülebilir bir enerji tedarikçisi olmaktır. Teknolojik
            gelişmeleri yakından takip ederek çevreye duyarlı ve yenilikçi
            çözümler üretmek, toplumumuza ve iş ortaklarımıza değer katmak en
      ...
      <article className=" mt-12 px-20 gap-10">
        <div className="flex flex-col items-center justify-center  my-5">
          <h1 className="text-2xl font-semibold ">Vizyonumuz</h1>
          <hr className="w-32 h-[3px] bg-primary"></hr>
        </div>
        <div className="items-center justify-center gap-4  w-full  mt-5 ">
          <p className="flex items-center justify-center mb-4">
            Sektördeki lider konumumuzu koruyarak Türkiye’nin en güvenilir ve
            tercih edilen akaryakıt istasyonlarından biri olmak, müşteri
            deneyimini sürekli geliştirerek hizmet ağımızı genişletmek ve
            sürdürülebilir enerji çözümleriyle geleceğe yatırım yapmak en büyük
            hedefimizdir.
          </p>
          <p className=" items-center justify-center mb-14">
            Turhanlar Petrol olarak köklü geçmişimizin verdiği güçle, geleceğe
            emin adımlarla ilerliyor; müşteri odaklı hizmet anlayışımız ve
            kaliteli ürünlerimizle sektörde iz bırakmaya devam ediyoruz.
          </p>
        </div>
      </article>
      {/* middle */}
